...
async.waterfall([
	...
	function(callback) {
		...
		config_json += "		\"plugins/pvf2_loader_st.so\",\n";
		...
		if(process.platform === 'darwin') {
			...
			config_json += "        \"plugins/mjpeg_tegra_encoder_st.so\",\n";
			config_json += "        \"plugins/mjpeg_tegra_decoder_st.so\",\n";
			config_json += "        \"plugins/v4l2_tegra_encoder_st.so\",\n";
			config_json += "        \"plugins/v4l2_tegra_decoder_st.so\",\n";
			...
			config_json += "        \"plugins/mpp_encoder_st.so\",\n";
			config_json += "        \"plugins/mjpeg_mpp_decoder_st.so\",\n";
